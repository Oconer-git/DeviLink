<div class="inline-block">
    ...
    <form wire:submit.prevent="toggleLike" class="inline-block">
        ...
        <button type="submit">
            @if ($liked)
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 md:w-7 bg-purple-700 rounded-full p-[2px] inline text-sky-100 hover:bg-red-700 fill-current" viewBox="0 -960 960 960" fill="#5f6368"><path d="M720-120H280v-520l280-280 50 50q7 7 11.5 19t4.5 23v14l-44 174h258q32 0 56 24t24 56v80q0 7-2 15t-4 15L794-168q-9 20-30 34t-44 14Zm-360-80h360l120-280v-80H480l54-220-174 174v406Zm0-406v406-406Zm-80-34v80H160v360h120v80H80v-520h200Z"/></svg>
            @else
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 md:w-7 bg-gray-100 rounded-full p-[2px] inline text-sky-600 hover:text-white hover:bg-sky-300 fill-current" viewBox="0 -960 960 960" fill="#5f6368"><path d="M720-120H280v-520l280-280 50 50q7 7 11.5 19t4.5 23v14l-44 174h258q32 0 56 24t24 56v80q0 7-2 15t-4 15L794-168q-9 20-30 34t-44 14Zm-360-80h360l120-280v-80H480l54-220-174 174v406Zm0-406v406-406Zm-80-34v80H160v360h120v80H80v-520h200Z"/></svg>
            @endif
        </button>
    </form>
