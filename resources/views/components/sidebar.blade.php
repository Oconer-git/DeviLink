<div class="fixed hidden px-4 py-3 top-16 left-8 md:w-3/12 md:block lg:left-2 align-top">
    ...
    <!-- explore -->
    <section class="w-full flex justify-start border-purple-300 pl-2 mb-3 group" id="followings_posts">
        ...
        <a class="text-xl text-gray-500 font-semibold ml-3 hover:text-teal-700 hover:drop-shadow-xl p-1">Followings</a>
    </section>
    <!-- saved -->
