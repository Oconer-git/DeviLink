<nav class="fixed z-20 flex flex-row  justify-between bg-gradient-to-l from-purple-100 to-white w-full px-2 pt-2 border-b-gray-500/25 drop-shadow-md">
    <!-- logo -->
    <section class="ml-4">
        <img src="{{ asset('storage/images/tealbean_logo_transparent.png') }}" class="home w-11 inline rounded-full -mt-1 md:-mt-3 p-1" alt="tealbean logo">
    ...
    <section class="mr-4">
        ...
        <div class="text-xxs absolute font-bold right-20 top-9 text-teal-600">
            <p>{{$requests->count()}}</p>
        </div>
