        ...
        <aside class="bg-whitesmoke w-full pb-96 sm:pb-12 rounded-md block mx-auto mt-2 align-top border-t-2 border-t-purple-500 lg:w-comments lg:inline-block lg:border-t-0 lg:border-l-4  lg:border-l-purple-500 ">
            ...
            <section class="bg-gray-50 drop-shadow-sm border-b-2 rounded-lg px-8 py-2">
                ...
                <figure class="inline-block ml-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 md:w-8 inline fill-current text-green-600" viewBox="0 -960 960 960"><path d="M240-400h480v-80H240v80Zm0-120h480v-80H240v80Zm0-120h480v-80H240v80ZM880-80 720-240H160q-33 0-56.5-23.5T80-320v-480q0-33 23.5-56.5T160-880h640q33 0 56.5 23.5T880-800v720ZM160-320h594l46 45v-525H160v480Zm0 0v-480 480Z"/></svg>
                    <p class="text-gray-600 text-xxs md:text-sm inline align-bottom">325</p>
                </figure>
                <!-- share button -->
                <form class="inline-block text-yellow-600 hover:text-orange-600 ml-2">
                    <button type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 md:w-8 inline fill-current " viewBox="0 -960 960 960"><path d="m600-200-56-57 143-143H300q-75 0-127.5-52.5T120-580q0-75 52.5-127.5T300-760h20v80h-20q-42 0-71 29t-29 71q0 42 29 71t71 29h387L544-624l56-56 240 240-240 240Z"/></svg>                        
                    </button>
                </form>
                <!-- number of shares -->
                <p class="text-gray-600 text-xxs md:text-sm inline align-bottom ">325</p>
