@include('partials.header')
    ...
    <div class="bg-gradient-to-l from-gray-200 to-gray-100/10 w-full mx-auto pt-[70px] px-4 pb-24"> 
        ...
        <main class="w-full sm:w-8/12 md:w-5/12 lg:w-5/12 mx-auto -mt-2 p-2 border-l border-r border-slate-400/20">
            <!-- people section  -->
            <button class="mb-2 inline-block align-middle rounded-full hover:bg-slate-300 p-1" id="back"> 
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 text-gray-600 hover:text-gray-80 fill-current" viewBox="0 -960 960 960" ><path d="M280-200v-80h284q63 0 109.5-40T720-420q0-60-46.5-100T564-560H312l104 104-56 56-200-200 200-200 56 56-104 104h252q97 0 166.5 63T800-420q0 94-69.5 157T564-200H280Z"/></svg>
            </button>
