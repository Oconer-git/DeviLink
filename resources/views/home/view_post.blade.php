    ...
    <div class="bg-white w-full mx-auto pt-[70px] px-4 pb-24"> 
        ...
        <main class="w-full py-2 sm:w-8/12 md:w-5/12 lg:w-7/12 lg:ml-56 mx-auto pr-0 lg:pl-4 lg:pr-20 lg:border-l-2 border-l-gray-400/20">
            ...
            @if($post->id != null)
                ...
                <!-- comments -->
                <div class="p-4 text-gray-800 max-h-screen border-t-2 small-scrollbar">
                    <!-- comment form textbox input -->
                    @livewire('comment-post', ['post_id' => $post->id])
                    <article>
                        <!-- comment section -->
                        ...
                        @if($comments->isEmpty())
                            ...
                            <p class="text-sm text-center mt-4 text-gray-500">Where are the rest of the comments?</p>
                        @else
                                ...
                                <section class="bg-white pt-1">
                                    ...
                                    <div class="inline-block align-midde">
                                        ...
                                        @if(isset($comment->user->skills))
                                            @include('partials.comments_skills_load', ['user_skills' => $comment->user->skills])
                                        @endif
                                    </div>      
                                    <!--comment-->
                                            ...
                                            <section class= "pl-2 mt-2 mb-4 border-l-2 border-l-gray-300">
                                                ...
                                                <div class="inline-block align-midde">
                                                    ...
                                                    @if(isset($reply->user->skills))
                                                        @include('partials.comments_skills_load', ['user_skills' => $reply->user->skills])
                                                    @endif
                                                </div>      
                                                <!--reply-->
