    ...
    <div class="bg-gradient-to-l from-gray-200 to-gray-100/10 w-full mx-auto pt-[70px] px-4 pb-24"> 
        ...
        <main class=" w-full sm:w-8/12 md:w-5/12 lg:w-5/12 mx-auto">
            ...
            <div class="bg-gray-100 group shadow-md drop-shadow-sm rounded-md h-24 mx-auto mt-1 mb-2 p-4 border-t-2 border-t-slate-100 hover:border-t-blue-400 hover:bg-stone-100 transition duration-500">
                <section class="p-2 ">
                    ...
                    <button id="post_modal" class="bg-gray-300 w-9/12 text-xs lg:text-sm lg:w-10/12 h-10 shadow-sm text-gray-500 align-middle rounded-full text-left pl-3 group-hover:bg-slate-400 group-hover:text-whitesmoke transition duration-300">
            ...
            @foreach ($posts as $post)
                @if($post->id == null)
                @else
                <div class="post bg-whitesmoke hover:bg-slate-100 hover:shadow-lg hover:shadow-slate-300 shadow-md drop-shadow-sm rounded-md mx-auto mb-2 p-5"
        ...
        <div class="z-5 fixed top-20 right-6 hidden md:w-3/12 md:block lg:w-3/12 align-top ">
                        ...
                        <section class="pl-1 mb-1 hover:bg-slate-200 p-1 rounded-lg flex group flex-col lg:flex-row items-center justify-between transition duration-300 ease-in-out">
                            <div class="flex items-start lg:items-center">
                                ...
                                <div class="inline-block align-middle ml-2 transition duration-300 ease-in-out">
                                    ...
                                    <a href="/profile/{{$user->username}}" class="text-cyan-600 text-xs text-md font-light transition duration-300 ease-in-out">{{'@'.$username}}</a>           
                                </div>
                            </div>
                            <form action="" class="align-middle  ml-2 transition duration-300 ease-in-out">
                                <button type="submit" class="px-2 h-7 w-18 bg-sky-400 group hover:bg-blue-700 rounded-md shadow-md transition duration-300 ease-in-out">
            ...
            <div class="mt-4 bg-gray-100 p-3 rounded-md shadow-md">
                ...
                <div class="bg-whitesmoke flex justify-between rounded-lg shadow-sm mb-2">
                    <img class="w-4/12 rounded-lg inline-block" src="{{asset("storage/images/profiles/4GXfLHCYWESckknQTiynOrLxiU1AhJpUsvMTlVfk.jpg")}}" alt="trending post">
                    <section class="w-9/12 p-2">
                        <p class="text-xs font-semibold text-slate-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi ratione fugit unde id. Sapiente eum dignissimos...</p>
                    </section>
                </div>
                <div class="bg-whitesmoke flex justify-between rounded-lg shadow-sm">
                    <img class="w-4/12 rounded-lg inline-block" src="{{asset("storage/images/profiles/4GXfLHCYWESckknQTiynOrLxiU1AhJpUsvMTlVfk.jpg")}}" alt="trending post">
                    <section class="w-9/12 p-2">
                        <p class="text-xs font-semibold text-slate-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi ratione fugit unde id. Sapiente eum dignissimos...</p>
                    </section>
